...
> **Importante:** Para realizar esta prática, faça login com o usuário **`administrador`** e a senha **`adminifal`** configurados na Aula 1 [36]. Sempre que precisar de privilégios elevados, utilize o prefixo `sudo`.
